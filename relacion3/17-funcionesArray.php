...
<body class="bg-light">
    <div class="container py-5">
        ...
        <?php
            ...
            echo '<li class="list-group-item">Mostrando la primera posición  del array combinado con current():<br>', current($reemplazado), '</li>';
            echo '<li class="list-group-item">Mostrando si un elemento pertenece al array combinado:<br>';
            if(in_array($numAleatorio, $reemplazado)){
                echo "$numAleatorio pertenece al array";
            } else{
                echo "$numAleatorio no pertenece al array";
            }
            echo "</li>";
            echo "</ul>";
            echo "</div></div>";
