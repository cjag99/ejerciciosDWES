...
<body>
    <div class="container-fluid w-100">
        <form action="./12-calificaciones.php" class="border border-0 rounded-4 shadow-lg p-4 p-4 bg-secondary bg-opacity-25 my-5 m-auto" method="get">
            ...
            <div class="mb-3">
                <label for="num2" class="form-label">Introduzca su nombre:</label>
                <input
            ...
            <div class="mb-3">
                <label for="num1" class="form-label">Introduzca nota inicial:</label>
                <input
                    class="form-control rounded-3 bg-secondary bg-opacity-25 border"
                    type="number"
                    name="inicial"
            ...
            <div class="mb-3">
                <label for="num2" class="form-label">Introduzca nota primera:</label>
                <input
                    class="form-control rounded-3 bg-secondary bg-opacity-25 border"
                    type="number"
                    name="primera"
            ...
            <div class="mb-3">
                <label for="num2" class="form-label">Introduzca nota segunda:</label>
                <input
                    class="form-control rounded-3 bg-secondary bg-opacity-25 border"
                    type="number"
                    name="segunda"
            ...
            <div class="mb-3">
                <label for="num2" class="form-label">Introduzca nota tercera:</label>
                <input
                    class="form-control rounded-3 bg-secondary bg-opacity-25 border"
                    type="number"
                    name="tercera"
